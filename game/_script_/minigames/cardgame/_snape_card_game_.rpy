...
label snape_duel_menu:
    if geniecard_level == 1:
        ...
        if not snape_wager_talk:
            ...
            call sna_main("Turns out... That card I gave you, whilst not very powerful was quite rare.","snape_08")
            ...
            if wine_ITEM.owned < 1:
                ...
                m "Can't we just duel anyway? I'm not intending to lose..."
                sna "Neither am I."
                sna "No wine, no duel."
                m "Damn!"
                m "(I should see if I could find some more wine in that cupboard, or perhaps check the local store...)"
...
label snape_first_duel:
    ...
    m "You, or the deck?"
    call sna_main("I...{w=0.3} The deck, obviously.","snape_14")
...
label snape_second_duel:
    ...
    if not her_know_cards:
        call bld
        g9 "This is awesome, I wonder if Miss Granger would want to play against me..."
...
label snape_third_duel:
    ...
    if snape_third_win == False:
        call sna_main("Impossible... There must be something wrong with my cards!","snape_05")
...
label snape_random_duel:
    ...
    if not random_snape_win:
        ...
        call sna_main("Hey, just because I reside in the dungeon it doesn't mean I--","snape_07")
        ...
        if random_choice == 0:
            ...
            m "Skill...{w=0.3} It's called skill."
            ...
            m "..."
            call sna_main("*Hmm*... Perhaps that comment might've been a bit...","snape_25")
            m "Yeah, a just a little..."
...
label snape_special_duel:
    ...
    if duel_response == "draw":
        ...
        call sna_main("Well, well.. It appears I've--")
        m "{size=+4}Fuuuuuuuuck!{/size}"
        return "loss"
...
label snape_duel_lost:
    ...
    if geniecard_level == 1:
        ...
        if random_number == 1:
            ...
            call sna_main("I'll have that wine now...","snape_02")
        else:
            sna "Hah!"
            ...
            m "..."
            m "Whatever you say, here's your bottle."
